...
<div class="jumbotron hh">
	<div class="row">
		...
		<h4 class="text-center text-success mt-2">OTP VERIFICATION</h4>
		<form class="form-group">
			<lavel class="text-white">OTP PLEASE</lavel>
               <div class="input-group-append">
								<span class="input-group-text"style="background: cyan"><i class="fas fa-phone"></i></span>
			<input type="number" name="" required placeholder="ENTER YOUR OTP" class="form-control"/></div><br>
			
			<center><button class="btn-warning" style="width:150px;height:40px;border-radius:10px;"><a href="newpassword.php">SUBMIT</a></button></center><br>
