...
<nav class="navbar navbar-expand-sm navbar-dark"style="background:#191927;">
    ...
    <li class="nav-item ml-2">
      ...
      <button class=" hvr hvr-fade" style="border:#343a40 solid;border-radius:10px;"><a href="contact.php" class="nav-link text-dark">CONTACT US</a></button>
		...
		<li class="nav-item ml-2">
      <button class=" hvr-fade" style="border:#343a40 solid;border-radius:10px;"><a href="upload.php" class="nav-link text-dark">UPLOAD-BOOKS</a></button>
    </li>
...
<div class="container-fluid">
  ...
  <div class="row"style="background:#808080">
      <div class="col-sm-12 text-center mt-2 h3 font-wieght-bold"><font color=orange>HISTORY</font><font color=orange>&nbsp OF LIBRARY<br>
        <input type=range style="width:160px;"/></div>
        <p align="justify"style="color:white" class="ml-4">
              ...
              <div class="row">
                <div class="col-md-4 icon-box v1">
                  ...
                  <div>
                    ...
                    <p class="text-white">
                  We are a leading library services providers in Uttar Pradesh and North India.      
                  </p>
                  </div>
                </div>
                <div class="col-md-4 icon-box v1">
                ...
                <div class="col-md-4 icon-box v1">
                  ...
                  <div>
                    ...
                    <p class="text-white">
                    We are working with Professional Teams, Entrepreneur our Most innovative team.
                  </p>
...
<div class="container-fluid"style="background:#7fffd4">
  <div class="row">
      <div class="col-sm-12 text-center mt-5 h3 font-wieght-bold">MEET OUR<font color=orange>&nbsp PROFESSIOAL TEAM<br></font><span class="h6 text-dark">WE HAVE HIGHLY QUALIFIED TEACHER</span><br>
        <input type=range style="width:160px;"/></div>
</div>
</div>
        ...
        <div class="col-sm-12 mt-4">
            ...
            <div style="width:100%;"class="a">
               ...
               <div class="card-body">
                ...
                <p class="card-text text-center  text-dark">(HOD OF LIBRARY)</p>
            ...
            <div style="width:100%;"class="b">
               ...
               <div class="card-body">
                ...
                <p class="card-text text-center text-dark">(MANAGEMENT TEACHER)</p>
            ...
            <div style="width:100%;"class="c">
               ...
               <div class="card-body">
                ...
                <p class="card-text text-center text-dark">(MANAGER OF LIBRARY)</p>
            ...
            <div style="width:100%;"class="d">
               ...
               <div class="card-body">
                ...
                <p class="card-text text-center text-dark">(HEAD OF LIBRARY)</p>
...
<div class="container-fluid">
  ...
  <div class="row"style="background:#030817">
      <div class="col-sm-12 text-center mt-2 h3 font-wieght-bold"><font color=orange>OUR</font><font color=orange>&nbsp VISION<br>
        <input type=range style="width:160px;"/></div>
        <p align="justify"style="color:white" class="ml-4">
          The maintenance of a good library is a sin qua non for any progressive university, therefore, the then Canning College Library was converted into the University Central Library and thus the Tagore Library, the Central Library of the University of Lucknow came into existence with the establishment of the Lucknow University late in the year 1920.
 ...
 <div class="container-fluid">
 	<div class="row">
 		<div class="col-sm-12 bg-success p-0">
            <p class="h5 text-white mt-2"><marquee behavior=alternate> @ COPYRIGHT 2022 ON 03/03/2022 BY:-Lovely Professional University. DEVLOPED BY:ANUJ KUMAR GUPTA GUIDED BY Mr.Nishant Agnihotri.</marquee></p>
 		</div>
 	</div>
 </div>			
<!--------------END BOOK GALLARY--------->
