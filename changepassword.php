...
<div class="row">s
		...
		<form class="form-group" action="changepasscode.php" method="post">
			...
			<input type="password" name="txt1" required placeholder="ENTER OLD PASSWORD" class="form-control"/></div>
			<div class="mt-3"></div>
			<lavel class="text-white"> NEW PASSWORD</lavel>
               <div class="input-group-append">
								<span class="input-group-text"style="background: cyan"><i class="fas fa-key"></i></span>
			<input type="password" name="txt2" required placeholder="ENTER YOUR NEW PASSWORD" class="form-control"/></div><br>
			<lavel class="text-white"> CONFIRM PASSWORD</lavel>
               <div class="input-group-append">
								<span class="input-group-text"style="background: cyan"><i class="fas fa-key"></i></span>
			<input type="password" name="txt3" required placeholder="ENTER CONFIRM PASSWORD" class="form-control"/></div><br>
