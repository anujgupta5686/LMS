...
// ]]>
   ...
   Mobile Number  +91-8601246751 ,+91-9149374942</p> </div>
    ...
    <div class="row">
        <div class="col-sm-12 mt-4">
            ...
            <div style="width:100%;" class="c">
               ...
               <div class="card-body">
                <h3 class="card-title text-center">Mr. Amit Verma</h3>
                ...
                <div class="col-md-2 col-sm-3">
                 ...
                 <div class="col-md-2 col-sm-3">
                    <div class="box1">
                        ...
                        <h3 class="title">AUTHOR:-ANUJ JAIN</h3>
                        <ul class="icon">
    ...
    <div class="modal-dialog">
        <div class="modal-content hh">
            ...
            <div class="modal-body"><BR>
				<h2 class="text-white text-center"><i>WELCOME TO<BR>ANUJ MODERN LIBRARY</i></h2>
         <h4 class="text-white text-center mt-3">MANAGER:- ER. ANUJ KUMAR GUPTA</h4>
         <h4 class="text-white text-center mt-2">CONTACT:- +91-8601246751</h4>
