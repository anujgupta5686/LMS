...
<div class="row">
		...
		<h4 class="text-center text-success mt-2">USER LOGIN</h4>
		<form class="form-group" action="logcode.php" method="post">
			...
			<input type="email" name="txt1" required placeholder="ENTER YOUR NAME" class="form-control"/></div>
			<div class="mt-3"></div>
			<lavel class="text-white">PASSWORD</lavel>
               <div class="input-group-append">
								<span class="input-group-text"style="background: cyan"><i class="fas fa-key"></i></span>
			<input type="password" name="txt2" required placeholder="ENTER YOUR PASSWORD" class="form-control"/></div><br>
			<center><button class="btn-warning" style="width:150px;height:40px;border-radius:10px;">SUBMIT</button></center><br>
			<a href="adminlogin.php" class="ml-5 text-white h4"style="text-decoration:none">NEW USER</a></h5>
		</form>
