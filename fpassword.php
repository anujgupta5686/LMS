...
<div class="jumbotron hh">
	<div class="row">
		...
		<h4 class="text-center text-success mt-2">FORGET PASSWORD</h4>
		<form class="form-group">
			<lavel class="text-white">MOBILE</lavel> 
			<div class="input-group-append">
								<span class="input-group-text"style="background: cyan"><i class="fas fa-phone"></i></span><input type="number" name="" required placeholder="ENTER YOUR MOBIE NUMBER" class="form-control"/></div>
			<p align=center class=" h3 text-success mt-4">OR</p>
			<lavel class="text-white">EMAIL</lavel>
                     <div class="input-group-append">
								<span class="input-group-text"style="background: cyan"><i class="fas fa-envelope"></i></span>
			<input type="email" name="date" required placeholder="ENTER YOUR EMAIL" class="form-control"/></div><br>
			
			<center><button class="btn-warning" style="width:150px;height:40px;border-radius:10px;"><a href="fpassword1.php">SUBMIT</a></button></center><br>
