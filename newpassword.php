...
<div class="jumbotron hh">
	<div class="row">
		...
		<h4 class="text-center text-success mt-2">NEW PASSWORD</h4>
		<form class="form-group">
			<lavel class="text-white">EMAIL</lavel>
               <div class="input-group-append">
								<span class="input-group-text"style="background: cyan"><i class="fas fa-user"></i></span>
			<input type="email" name="" required placeholder="ENTER YOUR NAME" class="form-control"/></div>
			<div class="mt-3"></div>
			<lavel class="text-white ">NEW PASSWORD</lavel>
                 <div class="input-group-append">
								<span class="input-group-text"style="background: cyan"><i class="fas fa-key"></i></span>
			<input type="password" required name="password" placeholder="ENTER YOUR NEW PASSWORD" class="form-control"/></div><br>
